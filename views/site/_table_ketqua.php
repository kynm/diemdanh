                        ...
                        <tbody>
                            ...
                            $tongmuctieuthang += $value['KEHOACHTHANG'];
                                ...
                                <tr>
                                    ...
                                    <td scope="col" style="color: red;"><b><?= round($value['DAGIAHAN'] * 100/$value['KEHOACHTHANG'], 2)?> %</b></td>
                                </tr>
                            <?php endforeach; ?>
                            <tr>
                                    <td scope="col"></td>
                                    ...
                                    <td scope="col" style="color: red;"><b><?= round($tongdagiahan * 100/$tongmuctieuthang, 2)?> %</b></td>
                                </tr>
                        </tbody>
                    </table>
                </div>
