    ...
    <table class="table">
        <tbody>
            ...
            <tr>
            	...
            	<td colspan="2" style="border: 1px solid;"><h4><b><?= $model->hocsinh->HO_TEN?></b></h4></td>
            </tr>
            <tr>
                <td style="border: 1px solid;">LỚP</td>
                <td colspan="2" style="border: 1px solid;"><h4><b><?= $model->hocphi->lop->TEN_LOP?></b></h4></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2" style="border: 1px solid;">
                    ...
                    <?php if ($model->STATUS):?>
                        <b><span class="btn btn-lg btn-success">Đã thu</span></b>
                    <?php endif; ?>
                    </td>
            </tr>
