    ...
    <table class="table table-bordered" style="font-size: 18px;">
        <tbody>
            <tr class="bg-primary text-center">
                ...
                <th class="text-center" style="width: 10%;">Số buổi học</th>
                <th class="text-center" style="width: 10%;">Số tiền/buổi</th>
            ...
            <tr class="text-center">
                ...
                <td style="border: 1px solid;"><?= $model->SO_BN?></td>
                <td style="border: 1px solid;"><?= $model->TIENHOC?></td>
            ...
            <?php if($hocphichuathukhac):?>
                ...
                <?php foreach ($hocphichuathukhac as $key => $hp):?>
                    ...
                    <tr class="text-center">
                        ...
                        <td style="border: 1px solid; width: 15%;"></td>
                        <td style="border: 1px solid; width: 15%;"></td>
                        <td style="border: 1px solid; width: 7%;"><?= number_format($hp->TONG_TIENHOC)?></td>
                ...
                <tr class="text-center" style="border: 1px solid;">
                    <td style="border: 1px solid;" colspan="8">Tổng tiền</td>
