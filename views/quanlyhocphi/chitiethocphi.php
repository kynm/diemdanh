    ...
    <table class="table table-bordered" style="font-size: 18px;">
        <tbody>
            <tr class="bg-primary text-center">
                <th class="text-center" style="border: 1px solid;width: 15%;">Họ tên</th>
                <th class="text-center" style="border: 1px solid;width: 10%;">Lớp</th>
                <th class="text-center" style="border: 1px solid;width: 15%;">Ngày nghỉ</th>
                <th class="text-center" style="border: 1px solid;width: 10%;">Tiền học</th>
                <th class="text-center" style="border: 1px solid; width: 15%;">Tiền sách/ Tài liệu</th>
                <th class="text-center" style="border: 1px solid;width: 10%;">Tổng tiền</th>
                <th class="text-center" style="border: 1px solid;width: 20%;">Nhận xét</th>
            </tr>
            <tr class="text-center">
            	...
            	<td style="border: 1px solid;"><?= number_format($model->TONG_TIENHOC)?></td>
                ...
                <?php
                $tongtien = $model->TONG_TIEN?>
             <?php foreach ($hocphichuathukhac as $key => $hp):?>
                    <?php $tongtien += $hp->TONG_TIEN?>
                 <tr class="text-center">
                    <td style="border: 1px solid;"><?= $hp->hocphi->TIEUDE?></td>
                    <td style="border: 1px solid;"></td>
                    <td style="border: 1px solid;"><?= $hp->NGAY_NGHI?></td>
                    <td style="border: 1px solid;"><?= number_format($hp->TONG_TIENHOC)?></td>
                    <td style="border: 1px solid;"><?= number_format($hp->TIENKHAC)?></td>
                    <td style="border: 1px solid;"><?= number_format($hp->TONG_TIEN)?></td>
                    <td style="border: 1px solid;"><?= nl2br($hp->NHAN_XET)?></td>
                </tr>
            <?php endforeach;?>
