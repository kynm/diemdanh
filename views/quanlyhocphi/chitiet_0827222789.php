...
<div>
    <table class="table">
        <tbody>
            ...
            <?php endif;?>
            <tr>
                <td style="border: 1px solid;">STK</td>
                <td colspan="2" style="border: 1px solid;">050121199839</td>
            </tr>
            <tr>
                <td style="border: 1px solid;">NGÂN HÀNG</td>
                <td colspan="2" style="border: 1px solid;">SACOMBANK</td>
            </tr>
            <tr>
