                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php echo $tongthang2 - $tongthang1 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang2 - $tongthang1) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang1 - $tongthang2) ;
                                ?>
                                    
                                </td>
                            <th scope="col"><?php echo formatnumber($tongthang3);?>
                                <?php echo $tongthang3 - $tongthang2 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang3 - $tongthang2) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang2 - $tongthang3) ;
                                ?>

                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang4);?>
                                <?php echo $tongthang4 - $tongthang3 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang4 - $tongthang3) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang3 - $tongthang4) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang5);?>
                                <?php echo $tongthang5 - $tongthang4 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang5 - $tongthang4) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang4 - $tongthang5) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang6);?>
                                <?php echo $tongthang6 - $tongthang5 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang6 - $tongthang5) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang5 - $tongthang6) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang7);?>
                                <?php echo $tongthang7 - $tongthang6 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang7 - $tongthang6) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang6 - $tongthang7) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang8);?>
                                <?php echo $tongthang8 - $tongthang7 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang8 - $tongthang7) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang7 - $tongthang8) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang9);?>
                                <?php echo $tongthang9 - $tongthang8 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang9 - $tongthang8) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang8 - $tongthang9) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang10);?>
                                <?php echo $tongthang10 - $tongthang9 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang10 - $tongthang9) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang9 - $tongthang10) ;
                                ?>
                            </th>
                            <th scope="col"><?php echo formatnumber($tongthang11);?>
                                <?php echo $tongthang11 - $tongthang10 > 0 ? 
                                '<span class="glyphicon glyphicon-arrow-up btn-danger"></span>' . formatnumber($tongthang11 - $tongthang10) : '<span class="glyphicon glyphicon-arrow-down btn-success"></span>' . formatnumber($tongthang10 - $tongthang11) ;
                                ?>
                            </th>
