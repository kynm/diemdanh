...
<div class="noidungbaotri-view">
    ...
    <div class="box box-primary">
        <div class="box-body">
            <p>
                <?= (Yii::$app->user->can('edit-noidungbaotri')) ? Html::a('<i class="fa fa-pencil-square-o"></i> Cập nhật', ['update', 'id' => $model->MA_NOIDUNG], ['class' => 'btn btn-primary btn-flat']) : '' ?>
                <?= (Yii::$app->user->can('delete-noidungbaotri')) ? Html::a('<i class="fa fa-trash-o"></i> Xóa', ['delete', 'id' => $model->MA_NOIDUNG], [
