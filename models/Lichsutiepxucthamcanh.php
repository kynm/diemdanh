 ...
 */
class Lichsutiepxucthamcanh extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function getDichvutuvan()
    {
        $dsdichvu = Yii::$app->db->createCommand("SELECT GROUP_CONCAT(DISTINCT ten_dv SEPARATOR ', ') DS_DICHVU FROM dichvu WHERE id IN (". $this->ds_dichvu .")")->queryAll();
        return $dsdichvu[0]['DS_DICHVU'];
    }
}
